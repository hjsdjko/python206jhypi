	...
	<div class="addEdit-block" :style='{"minHeight":"calc(100vh - 200px)","padding":"30px","margin":"0 auto","color":"#666","background":"#f5f5f5","width":"calc(100% - 60px)","fontSize":"16px","height":"100%"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 4px","color":"inherit","borderRadius":"4px","background":"#f6f6f6","width":"60%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="投资时间" prop="touzishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.touzishijian" 
						type="datetime"
						:readonly="ro.touzishijian"
						placeholder="投资时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 4px","color":"inherit","borderRadius":"4px","background":"#f6f6f6","width":"60%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.touzishijian" label="投资时间" prop="touzishijian">
					<el-input v-model="ruleForm.touzishijian" placeholder="投资时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 4px","color":"inherit","borderRadius":"4px","background":"#f6f6f6","width":"60%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="总额" prop="jine">
					<el-input v-model="jine" placeholder="总额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 4px","color":"inherit","borderRadius":"4px","background":"#f6f6f6","width":"60%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.jine" label="总额" prop="jine">
					<el-input v-model="ruleForm.jine" placeholder="总额" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 4px","color":"inherit","borderRadius":"4px","background":"#f6f6f6","width":"60%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="金额" prop="yonghujine">
					<el-input type="number" v-model.number="ruleForm.yonghujine" placeholder="金额" clearable  :readonly="ro.yonghujine"></el-input>
				</el-form-item>
				<el-form-item :style='{"padding":"2px 0","margin":"0 auto 4px","color":"inherit","borderRadius":"4px","background":"#f6f6f6","width":"60%","fontSize":"inherit"}' v-else class="input" label="金额" prop="yonghujine">
					<el-input v-model="ruleForm.yonghujine" placeholder="金额" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	created() {
		this.ruleForm.touzishijian = this.getCurDateTime()
	},
	methods: {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qihuotouzi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qihuotouziCrossAddOrUpdateFlag = false;
						 this.parent.search();
