...
<div :style='{"width":"68%","padding":"80px 0","margin":"10px auto","position":"relative","background":"transparent"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"32%","padding":"10px","margin":"0 0 10px","background":"transparent"}' label="投资时间" prop="touzishijian">
              <el-date-picker
				  :disabled="true  ||ro.touzishijian"
          ...
          <el-form-item :style='{"width":"32%","padding":"10px","margin":"0 0 10px","background":"transparent"}' label="总额" prop="jine">
          ...
          <el-form-item :style='{"width":"32%","padding":"10px","margin":"0 0 10px","background":"transparent"}' label="金额" prop="yonghujine">
            <el-input type="number" v-model.number="ruleForm.yonghujine" 
                placeholder="金额" clearable :readonly=" false  ||ro.yonghujine"></el-input>
          </el-form-item>
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`qihuotouzi/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
      ...
      onSubmit() {
        ...
        if(this.ruleForm.jine>this.ruleForm.yonghujine){
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post(`qihuotouzi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
                              if (res.data.code == 0) {
