...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","top":"0","flexWrap":"wrap","left":"0","background":"transparent","display":"flex","width":"20%","position":"absolute","height":"auto"}'>
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#000","display":"inline-block"}'>账户卡号：</div>
        <el-input v-model="formSearch.zhanghukahao" placeholder="账户卡号" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 10px"}'>
	  ...
	  <el-button v-if="btnAuth('chongzhixinxi','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"20px 10px 0 0","outline":"none","color":"#fff","borderRadius":"60px","background":"#313131","width":"auto","fontSize":"15px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/chongzhixinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"16px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	<div class="list" :style='{"width":"80%","padding":"0","margin":"0 0 0 20%","background":"#F6F6F6"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"0 0","flexWrap":"wrap","background":"#F6F6F6","display":"flex","height":"auto"}'>
			<div :style='{"border":"4px solid #fff","padding":"10px 20px","margin":"10px 5px","flexWrap":"wrap","background":"#fff","display":"flex","width":"32%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				<img @click.stop="imgPreView(item.touxiang)" :style='{"width":"100%","objectFit":"cover","display":"block","height":"275px","order":"2"}' v-if="item.touxiang && item.touxiang.substr(0,4)=='http'" :src="item.touxiang" class="image" />
				...
				<div :style='{"padding":"0 10px 10px","color":"#000000","textAlign":"center","width":"100%","lineHeight":"2","fontSize":"18px","fontWeight":"bold","order":"1"}' class="name ">{{item.zhanghukahao}}</div>
				<div :style='{"padding":"0 10px 10px","color":"#000000","textAlign":"center","width":"100%","lineHeight":"2","fontSize":"18px","fontWeight":"bold","order":"1"}' class="name ">{{item.xingming}}</div>
				<div :style='{"padding":"0 10px 10px","color":"#000000","textAlign":"center","width":"100%","lineHeight":"2","fontSize":"18px","fontWeight":"bold","order":"1"}' class="name ">{{item.jine}}</div>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.zhanghukahao != '') searchWhere.zhanghukahao = '%' + this.formSearch.zhanghukahao + '%';
