...
@main_bp.route("/python206jhypi/cal/<tableName>/<columnName>", methods=['GET'])
def python206jhypi_cal(tableName, columnName):
    '''
    计算规则接口
    '''
...
@main_bp.route("/python206jhypi/file/download", methods=['GET'])
def python206jhypi_file_download():
    '''
    '''
    if request.method == 'GET':
...
@main_bp.route("/python206jhypi/file/upload", methods=['POST'])
def python206jhypi_file_upload():
    '''
    '''
...
@main_bp.route("/python206jhypi/follow/<tableName>/<columnName>/<level>/<parent>", methods=['GET'])
def python206jhypi_follow_level(tableName, columnName, level,parent):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python206jhypi/follow/<tableName>/<columnName>", methods=['GET'])
def python206jhypi_follow(tableName, columnName):
    '''
...
@main_bp.route("/python206jhypi/location", methods=['GET'])
def python206jhypi_location():
    '''
...
@main_bp.route("/python206jhypi/matchFace", methods=['GET'])
def python206jhypi_matchface():
    '''
    baidubce百度人脸识别
    '''
    if request.method == 'GET':
...
@main_bp.route("/python206jhypi/option/<tableName>/<columnName>", methods=['GET'])
def python206jhypi_option(tableName, columnName):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python206jhypi/remind/<tableName>/<columnName>/<type>", methods=['GET'])  #
def python206jhypi_remind(tableName, columnName,type):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python206jhypi/sh/<tableName>", methods=['POST'])
def python206jhypi_sh(tableName):
    '''
    '''
    if request.method == 'POST':
        ...
        logging.warning("python206jhypi_sh.res=====>{}".format(res))
        return jsonify(msg)

@main_bp.route("/python206jhypi/upload/<fileName>", methods=['GET'])
def python206jhypi_upload(fileName):
    '''
    上传接口
    '''
    if request.method == 'GET':
...
@main_bp.route("/python206jhypi/group/<tableName>/<columnName>", methods=['GET'])
...
@main_bp.route("/python206jhypi/value/<tableName>/<xColumnName>/<yColumnName>", methods=['GET'])
