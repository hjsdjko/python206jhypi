...
# 注册接口
@main_bp.route("/python206jhypi/aboutus/register", methods=['POST'])
def python206jhypi_aboutus_register():
...
# 登录接口
@main_bp.route("/python206jhypi/aboutus/login", methods=['GET','POST'])
def python206jhypi_aboutus_login():
...
# 登出接口
@main_bp.route("/python206jhypi/aboutus/logout", methods=['POST'])
def python206jhypi_aboutus_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python206jhypi/aboutus/resetPass", methods=['POST'])
def python206jhypi_aboutus_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python206jhypi/aboutus/session", methods=['GET'])
def python206jhypi_aboutus_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python206jhypi/aboutus/page", methods=['GET'])
def python206jhypi_aboutus_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python206jhypi/aboutus/autoSort", methods=['GET'])
def python206jhypi_aboutus_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 分页接口（前端）
@main_bp.route("/python206jhypi/aboutus/list", methods=['GET'])
def python206jhypi_aboutus_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python206jhypi/aboutus/save", methods=['POST'])
def python206jhypi_aboutus_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/python206jhypi/aboutus/add", methods=['POST'])
def python206jhypi_aboutus_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python206jhypi/aboutus/thumbsup/<id_>", methods=['GET'])
def python206jhypi_aboutus_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python206jhypi/aboutus/info/<id_>", methods=['GET'])
def python206jhypi_aboutus_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python206jhypi/aboutus/detail/<id_>", methods=['GET'])
def python206jhypi_aboutus_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python206jhypi/aboutus/update", methods=['POST'])
def python206jhypi_aboutus_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/python206jhypi/aboutus/delete", methods=['POST'])
def python206jhypi_aboutus_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python206jhypi/aboutus/vote/<int:id_>", methods=['POST'])
def python206jhypi_aboutus_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/python206jhypi/aboutus/group/<columnName>", methods=['GET'])
def python206jhypi_aboutus_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/python206jhypi/aboutus/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python206jhypi_aboutus_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/python206jhypi/aboutus/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python206jhypi_aboutus_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 按值统计（多）
@main_bp.route("/python206jhypi/aboutus/valueMul/<xColumnName>", methods=['GET'])
def python206jhypi_aboutus_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/python206jhypi/aboutus/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def python206jhypi_aboutus_valueMul_time(xColumnName):
...
# 推荐算法接口
@main_bp.route("/python206jhypi/aboutus/autoSort2", methods=['GET'])
def python206jhypi_aboutus_autoSort2():
    if request.method == 'GET':
...
# 统计接口
@main_bp.route("/python206jhypi/aboutus/remind/<columnName>/<type>", methods=['GET'])  #
def python206jhypi_aboutus_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/python206jhypi/aboutus/lists", methods=['GET'])
def python206jhypi_aboutus_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
